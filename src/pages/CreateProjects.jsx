...
const CreateProject = () => {
  ...
  const columns = [
    { field: "id", headerName: "ID", width: 80, flex: 2 },
    { field: "ProjectCategoryName", headerName: "Project Category", width: 170, flex: 2  },
    { field: "ProjectName", headerName: "Project Name", width: 240, flex: 3  },
    {
