...
const ProjectAllocationByFnA = () => {
  ...
  const handleClone = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(`${base_URL}/api/ProjectAllocation/Details?EmpCode=${formData.departmentId}&Month=${month}&Year=${year}`
        ,
        {
          headers: {
            'Authorization': `Bearer ${Token}`
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(`${base_URL}/api/ProjectAllocation/Details?EmpCode=${formData.departmentId}&Month=${formData.month}&Year=${formData.year}`
        ,
        {
          headers: {
            'Authorization': `Bearer ${Token}`
      ...
      <div className="p-2 w-[90%] flex justify-end mx-auto mt-5">
        <form onSubmit={handleSearch} className="flex items-center space-x-2">
          ...
          >
            ...
            {/* Hardcoded options */}
            <option value="1198">EAM</option>
            <option value="314">RM-NORTH</option>
            <option value="303">RM-SOUTH</option>
            <option value="62">RM-EAST</option>
            <option value="118">RM-WEST</option>
          </select>
        ...
        <div className="border border-gray-300 p-1 bg-white shadow-md rounded-lg">
          <div className="flex justify-between bg-dark-purple">
            <Typography variant="h6" className="text-white font-medium p-1">
              Resource Allocation, {dept} ({dmonth})
            </Typography>
...
export default ProjectAllocationByFnA;